    ...
    <div className="w-full bg-center bg-cover h-[38rem]" style={{ backgroundImage: `url('${imageUrl}')` }}>
        <div className="flex items-center justify-center w-full h-full bg-gray-900/40">
            <div className="text-center">
                ...
                <button className="w-full px-5 py-2 mt-4 text-sm font-medium text-white capitalize transition-colors duration-300 transform bg-green-600 rounded-md lg:w-auto hover:bg-green-500 focus:outline-none focus:bg-green-500">Start browsing</button>
            </div>
        </div>
    </div>
    <Carousel />
